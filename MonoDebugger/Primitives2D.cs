...
{
    /// <summary>
    /// Copied from https://github.com/z2oh/C3.MonoGame.Primitives2D
    /// and updated/modified for my usecase
	/// </summary>
	public static class Primitives2D
    {
        ...
        public static void FillCircle(this SpriteBatch spriteBatch, Vector2 center, float radius, int sides, Color color)
        {
            ...
            List<Vector2> circle = CreateCircle(radius, sides);
            for (int i = 1; i < circle.Count; i++)
            {
                Vector2 point1 = circle[i - 1] + center;
                Vector2 point2 = circle[i] + center;
                DrawLine(spriteBatch, point1, point2, color, radius * 2);
            }
        }
    }
}
