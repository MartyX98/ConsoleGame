...
namespace ConsoleGame
{
    ...
    public class ConsoleBufferWriter
    {
        ...
        /// <summary>
        /// Writes a CharGrid to the console screen buffer at the specified position.
        /// </summary>
        /// <param name="g"> The CharGrid to be written to the console.</param>
        /// <param name="x"> The X-coordinate of the starting position for writing.</param>
        /// <param name="y"> The Y-coordinate of the starting position for writing.</param>
        /// <param name="doNotChunk"></param>
        ...
        /// <summary>
        /// Writes a single character to the console screen buffer at the specified position.
        /// </summary>
        /// <param name="c"> The character to be written to the console.</param>
        /// <param name="x"> The X-coordinate of the starting position for writing.</param>
        /// <param name="y"> The Y-coordinate of the starting position for writing.</param>
        ...
        /// <summary>
        /// Writes an array of characters to the console screen buffer at the specified position.
        /// </summary>
        /// <param name="chars"> The array of characters to be written to the console.</param>
        /// <param name="x"> The X-coordinate of the starting position for writing.</param>
        /// <param name="y"> The Y-coordinate of the starting position for writing.</param>
        /// <exception cref="InvalidOperationException"></exception>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ConsoleBufferWriter"/> class.
        /// </summary>
